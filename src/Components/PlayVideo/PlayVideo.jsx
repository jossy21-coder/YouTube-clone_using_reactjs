...
const PlayVideo = ({ videoId }) => {
  ...
  const fetchOtherData = React.useCallback(async () => {
    if (!apiData) return;
  ...
  useEffect(() => {
    fetchVideoData();
    fetchCommentData();
  }, [fetchVideoData, fetchCommentData]);
    ...
    <div className="play-video">
      ...
      <div className="play-video-info">
        ...
        <div>
          ...
          <span>
            <img src={share} alt="" />
            {apiData ? value_converter(apiData.statistics.shareCount) : 0}
          </span>
          <span>
            <img src={save} alt="" />
            {apiData ? value_converter(apiData.statistics.saveCount) : 0}
          </span>
        </div>
      </div>
      <hr />
